...
#import "NSObject+TLAssociation.h"

@interface UIView (TLTipViewPrivate)
...
@implementation UIView (TLTipViewPrivate)
...
#pragma mark - ## UIView (TLTipView)
@implementation UIView (TLTipView)
